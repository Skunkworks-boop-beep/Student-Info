...
const CANNED_RESPONSES: { keywords: string[]; response: string }[] = [
  {
    keywords: ['grade', 'appeal', 'marks', 'exam', 'assignment', 'lecturer', 'professor', 'rubric'],
  ...
  {
    keywords: ['scholarship', 'bursary', 'financial', 'fee', 'payment', 'funding'],
  ...
  {
    keywords: ['draft', 'write', 'format', 'template', 'create', 'help'],
  ...
  {
    keywords: ['facilities', 'maintenance', 'elevator', 'broken', 'repair', 'toilet', 'bathroom', 'classroom'],
    response: 'For facilities issues, the most effective thoughts include: the exact room or building code, how long the issue has existed, and how many students are affected. I\'ve added all three to your draft — facilities admin typically responds to these within 48 hours when marked Medium or above.',
  },
];
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            onClick={() => {
              ...
              setThreadMessages(prev => ({
                ...prev,
                [newId]: [{ role: 'ai', text: 'New session started. What would you like to work on today?' }],
              }));
